                ...
                <div className="information-container">
                  ...
                  <div className="w-full flex flex-col text-center">
                    ...
                    <div className="w-8/12 text-center ml-8  mobile:m-auto mb-8 font-medium">
                      <span className="ml-10 text-center mobile:ml-8 ">{pokemon.height/10}m</span>
                      <span className="ml-11 text-center mobile:ml-8 ">{pokemon.weight/10}kg</span>
                      <span className="ml-12 text-center mobile:ml-8 ">{pokemonInPokeball[0].gender}</span>
                    </div>
                    <div className="relative right-12 tablet:left-0 laptop:left-32 w-8/12 text-center m-auto mt-4 mb-4 flex items-center content-between items-baseline">
                      <div className="ml-8 mr-20">
                        <span className="box font-extrabold">Habilities</span>
