...
export const fetchRequest = (counter:any) => (dispatch:any) => {
...
export const handlerFetch = (pokemonsInList:any) => (dispatch:any) => {
    dispatch({
...
export const addSelectedPokemon = (pokemon:any, pokemonUrl:any, pokemonDescriptionUrl:any) => (dispatch:any) => {
    Promise.all([
        ...
        if (pokemonDescriptionRes.gender_rate >= 0 &&
...
export const cleanSelectedPokemons = () => (dispatch:any) => {
    dispatch({
...
export const setComparisonChart = (showChart:any) => (dispatch:any) => {
    dispatch({
...
export const addSearch = (search:any, pokemonsArrayIn:any) => ({
    type: ADD_SEARCH,
    payload: {
        search,
        pokemonsList: pokemonsArrayIn.filter((pokemon:any) => pokemon.name.toLowerCase().includes(search.toLowerCase()))
    },
});
/* This function assigns the original array of pokemons to the list */
export const returnToList = (pokemonSecondary:any) => (dispatch:any) => {
    dispatch({
        type: CLEAN_SELECTED_POKEMON,
        payload: {
